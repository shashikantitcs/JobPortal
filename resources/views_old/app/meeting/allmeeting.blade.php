      ...
      <div class="d-flex align-items-center justify-content-between flex-wrap border-bottom pb-3 mb-3">
        <div class="d-flex align-items-center">
         <!--  <button class="btn btn-danger btn-sm">Shubham</button> -->
          <h4 class="mb-0 font-weight-bold">Manage Meeting</h4>
          ...
          <div class="d-none d-md-flex ml-3">
            ...
            <p class="text-muted mb-0 tx-13 cursor-pointer">Manage Meeting</p>
          </div>
        </div>
        @if ($ses_um_user_type == 'MA' || $ses_um_user_type == 'A')
    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body boxShadow">
            <h4 class="card-title text-success">All Meeting List</h4>
                ...
                <tbody>
                    ...
                    <td> 
                      ...
                      <td class="text-danger">
                        ...
                        <b>{{ ucfirst($m->um_first_name.' '.$m->um_last_name)  }}
                        </b></br>
                        <i class="mdi mdi-email-open"></i>
                        <b>{{ ucfirst($m->um_email) }}</b>
                      </td>

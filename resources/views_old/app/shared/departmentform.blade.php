        ...
        <div class="col-12 grid-margin stretch-card">
          ...
          <div class="card">
            ...
            <div class="card-body boxShadow">
              <h4 class="text-warning text-bold">Update Product Detail</h4>
            ...
            <form action="{{ route('department.update',['department'=>$editdepartment->dm_id]) }}" method="POST" data-parsley-validate="">
                ...
                @method('PUT')
                  <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                            <label for="departmentshortName">Brand Name</label>
                            <input type="text" class="form-control departmentshortName @error('dm_short_name') parsley-error @enderror" id="departmentshortName" required="" placeholder="EnterDepartment Short Name" name="dm_short_name" data-parsley-maxlength="100" data-parsley-trigger="change" value="{{ $editdepartment->dm_short_name }}">
                            @error('dm_short_name')  
                            <small class="validate-err">{{$message}}</small>
                           @enderror
                          </div> 
...
{{--                     
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="departmentDescription">Brand Description</label>
            ...
            <div class="row">
              ...
              <div class="border border-primary rounded boxShadow">
                ...
                <ul class="a" style="list-style-type:square;">
                  ...
                  &nbsp;
                  &nbsp;
                  <button id="removeProduct" class="btn btn-primary">
                    remove
                  </button>
                  </li>
                  @endforeach
          ...
          <div class="card">
            ...
            <form action="{{ route('department.store') }}" method="POST" data-parsley-validate="" enctype="multipart/form-data">
              {{ csrf_field() }}
                  <div class="row">
                      <div class="col-md-4">
                          <div class="form-group">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                            <label for="departmentshortName">Brand Name</label>
                            <input type="text" class="form-control departmentshortName @error('dm_short_name') parsley-error @enderror" id="departmentshortName" placeholder="Enter Department Short Name" name="dm_short_name" reqired="" data-parsley-maxlength="100" data-parsley-trigger="change" value="{{ old('dm_short_name') }}">
                            @error('dm_short_name')  
                            <small class="validate-err">{{$message}}</small>
                           @enderror
                          </div> 

        ...
        <div class="card boxShadow">
          ...
          <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
            <div class="card-body">
             ...
             <p><strong> STEP 2:</strong> If don’t have Login Credential You have Contact to Admin.</p>
            </div>
          </div>
        </div>
        <div class="card boxShadow">
          ...
          <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
            <div class="card-body">
              ...
              <p><strong> STEP 4:</strong> A Form Will Appear after clicking on Add user button, Fill the form now user is created.</p>

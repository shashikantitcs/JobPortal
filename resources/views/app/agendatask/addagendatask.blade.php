...
<div class="content-wrapper">
    <div class="dashboard-header d-flex flex-column grid-margin">
      <div class="d-flex align-items-center justify-content-between flex-wrap border-bottom pb-3 mb-3">
        <div class="d-flex align-items-center">
         ...
         <h4 class="mb-0 font-weight-bold">Update Agneda Task Title & Detail</h4>
         @else
         <h4 class="mb-0 font-weight-bold">Add Agenda Task</h4>
         @endif
          ...
          <div class="d-none d-md-flex ml-3">
            ...
            <p class="text-muted mb-0 tx-13 cursor-pointer">
              @if (isset($editagendatask))
              Update Agenda Task Title & Detail
            @else
            Add Agendas Task</p>
            @endif
          </div>
   ...
   @include("app.shared.agendataskform")

...
@endphp
 <nav class="sidebar sidebar-offcanvas boxShadow" id="sidebar">
    ...
    <ul class="nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{ route('jobad.create')}}">
          <i class="mdi mdi-clipboard-text-outline menu-icon"></i>
          <span class="menu-title">Post Job Ad</span>
        </a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="{{ route('jobad.index')}}">
          <i class="mdi mdi-clipboard-text-outline menu-icon"></i>
          <span class="menu-title">Fresher Job Ad</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="{{ route('jobad.deputationjobad')}}">
          <i class="mdi mdi-clipboard-text-outline menu-icon"></i>
          <span class="menu-title">Deputation Job Ad</span>
        </a>
      </li>
{{--     
      <li class="nav-item">

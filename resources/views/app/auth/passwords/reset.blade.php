          ...
          <div class=" login-block">
           <!--  <div id="ashoklogoDiv" style="margin-top: 10px;margin-bottom:10px;">
            ...
            <div id="ngoGrantsDiv">
              ...
              <div id="loginDiv">
                <h5 class="text-center ngo-login-form">Reset Password</h5>
                {{-- alert msg --}}
                ...
                <form action="{{ route('user.updatepassword') }}" method="POST" data-parsley-validate="">
                   {{ csrf_field() }}
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-8">
                      <input type="password" class="form-control cutsomInput password_confirmation @error('password_confirmation') parsley-error @enderror" autocomplete="off" id='password_confirmation' name='password_confirmation' placeholder="Confirm Password" data-parsley-required="" data-parsley-trigger="change" value="" >
                 ...
                 <div class="row mb-3">
                    ...
                    <div class="col-sm-2">
                      ...
                      title="Reset Captcha" style="width:52px;">
                  ...
                  text-center">
                     ...
                     <input type="submit" class="btn btn-success btn-md" id="valideteUser" value="Reset Password">

        ...
        <!--   <div class="panel-heading text-center">Ministry Of Information & Broadcasting</div> -->
          ...
          <div class=" login-block">
            ...
            <div id="ngoGrantsDiv">
              ...
              <div id="loginDiv">
                <h5 class="text-center ngo-login-form">Forgot Password Request</h5>
                {{-- alert msg --}}
                 ...
                 <div class="row mb-3">
                   <!--  <label for="inputPassword" class="col-sm-4 col-form-label"></label> -->
                    ...
                    <div class="col-sm-6" style="padding-right: 0px;">
                     <img  src="{{$captcha}}" id="captchaImg" class="captchaImg" style="padding-left: 8px;width: 100%;height: 40px;"/>
                    </div>
                    <div class="col-sm-2">
                  ...
                  text-center">
                     ...
                     <input type="submit" class="btn btn-success btn-md" id="forgetPasswordForm" value="Submit">
